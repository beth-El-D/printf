 ...
 * @buffer: buffer array to handl prints
 * @flags: active flags
 * @width: get width
 * @precision: precision: precision specification
 * @size: size specifier
...
/**
 * print_non_printable - prints ascii code in hexadecimal of non_printable char
